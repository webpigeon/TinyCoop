...
public class GameCli {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		if (levelFiles == null) {
			levelFiles = new String[] { "data/norm_maps/airlock.txt", "data/norm_maps/butterfly.txt",
		...
		if (secondAgentList == null) {
			secondAgentList = new String[] { "mcts(500;10;45)", "random", "baisRandom(0.75)", "baisRandom(0.5)",
					"baisRandom(0.25)" };
		}
