...
public abstract class Player {
     ...
     */
    public abstract Action act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer);
     ...
     * @return An action for the current state
     */
    public abstract Action act(StateObservationMulti stateObs, ElapsedCpuTimer elapsedTimer);
