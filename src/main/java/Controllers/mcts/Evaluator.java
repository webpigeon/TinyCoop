...
public class Evaluator {
	 ...
	 * 
	 * @param wins the wins for all children
	 * @param visits the visits for all children
	 * @param totalVisits 
	 ...
	 * Calculate UCT value
	 * 
	 * @param wI win rate for this arm
	 * @param nI visit rate for this arm
	 * @param t total visits for all arms
